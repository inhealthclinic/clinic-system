...
/**
 * <AutomationKanban /> — визуальный редактор автоматизаций воронки «Лиды».
 * Используется на /settings/pipelines (под редактором этапов) и на
 * /settings/automation как отдельный экран.
 *
...
export default function AutomationKanban() {
