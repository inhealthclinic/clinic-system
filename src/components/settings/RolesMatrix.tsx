...
/**
 * Матрица «право × роль» с логическими цепочками.
 * Используется на /settings/users (вкладка «Роли и права»).
 *
 * Возможности:
 *   1. Автокаскад ON: включение write-права автоматически включает view (и др. prereqs).
 *   2. Автокаскад OFF: снятие view предлагает снять все зависимые права.
    ...
    <div>
      <div className="flex items-center justify-between mb-4 gap-3 flex-wrap">
        <div>
          ...
          <p className="text-xs text-gray-400">{roles.length} ролей · {perms.length} прав</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
          ...
          <div className="px-4 py-3 border-t border-gray-100 flex flex-wrap items-center gap-4 bg-gray-50/50">
            ...
            <span className="text-xs text-gray-400">
              При включении права автоматически добавятся зависимые. При отключении view — каскад снимет всё.
            </span>
          </div>
        </div>
      )}
